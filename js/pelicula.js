...
const getPeliculas = async () => {
    const data = await fetch(`http://localhost/cinestar_sweb/peliculas`);
    if ( data.status === 200 ) {
        ...
        let html = `<br/><h1>Cartelera</h1><br/>`;
            ...
            <div class="contenido-pelicula">
					...
					<div class="pelicula-video">
						...
						<embed src="https://www.youtube.com/v/2QKg5SZ_35I" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="580" height="400">
					</div>
            `
