...
const getPeliculas = async () => {
    const data = await fetch(`http://localhost/cinestar_sweb/peliculas/${idx}`);
    if ( data.status === 200 ) {
            ...
            <div class="contenido-pelicula">
                <div class="datos-pelicula">
                    ...
                    <div class="boton-pelicula"> 
                        <a href="pelicula.html?idd=${pelicula.id}" >
                            <img src="img/varios/btn-mas-info.jpg" width="120" height="30" alt="Ver info"/>
                        </a>
                    </div>
                    <div class="boton-pelicula"> 
                        <a href="https://www.cinestar.com.pe/popups/trailer/${pelicula.Link}" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" >
